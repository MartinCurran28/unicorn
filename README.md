...
Finally, users who wish to become part of the Unicorn family can do so through the **Join the Team!** Option in the website’s footer. This option will take a potential applicant to a form designed to collect information about the applicant as well as a space to compose his or her Cover Letter and attach their Curriculum Vitae for consideration. Similar to the Debug form, once submitted, Users will be thanked for their application and receive a PENDING status update.
